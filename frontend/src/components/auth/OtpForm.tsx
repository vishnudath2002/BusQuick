      ...
      <div className="min-h-screen bg-gray-50 flex">
        ...
        <div className="hidden lg:flex lg:w-1/2 bg-indigo-50 items-center justify-center">
          ...
          >
            ...
            <text x="130" y="320" fill="#4F46E5" fontSize="24" fontWeight="bold">
              #
            </text>
            <text x="190" y="320" fill="#4F46E5" fontSize="24" fontWeight="bold">
              *
            </text>
            <text x="250" y="320" fill="#4F46E5" fontSize="24" fontWeight="bold">
              #
            </text>
          </svg>
        </div>
